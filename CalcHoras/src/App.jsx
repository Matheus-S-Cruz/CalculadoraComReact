    ...
    <>
      ...
      <h3>Escolha os horários que deseja calcular!</h3>
       ...
       />&nbsp; : &nbsp;
        ...
        <input type="number" value={mf} onChange={(e) => setMf(e.target.value)} placeholder="Minuto Final"
        /><br/><br/>

        <button className='btn' onClick={soma}>Soma</button>
        <button className='btn' onClick={sub}>Subtração</button>
